...
from scheduler import app, db, login_manager
from scheduler.models.models import User, Courses, Assignment, Exam
from scheduler.models.forms import LoginForm, RegisterForm, NewCourseForm, NewExamForm, NewAssignmentForm
